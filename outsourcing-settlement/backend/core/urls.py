...
urlpatterns = [
    ...
    path("batches/<str:code>/trajectory/", views.BatchTrajectory.as_view()),
    ...
    path("batches/<str:code>/liability-determinations/", views.LiabilityDeterminationPost.as_view()),
    ...
    path("transfers/", views.TransferPost.as_view()),
    path("transfer-receipts/", views.TransferReceiptPost.as_view()),
]
